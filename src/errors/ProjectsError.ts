...
export const ERROR_NOT_VALID_PROJECT_ID = "Not a valid projectId";
...
export const ERROR_NO_TEAM_ID = "Team id is not valid or does not exist.";
export const ERROR_NO_PROJECT_SECTION_ID = "Please send at least one projectSectionId.";
export const ERROR_INVALID_TEAM_ID = "Please provide a valid teamId";

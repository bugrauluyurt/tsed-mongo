...
export const ERROR_MILESTONE_BODY_MIN_LENGTH = `Milestone body should be min ${MilestoneUtils.MILESTONE_BODY_MIN_LENGTH} characters.`;
export const ERROR_MILESTONE_BODY_MAX_LENGTH = `Milestone body should be max ${MilestoneUtils.MILESTONE_BODY_MAX_LENGTH} characters long.`;
